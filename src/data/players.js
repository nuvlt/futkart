...
//
// foto: Wikimedia Commons "Special:FilePath" linki. Bu endpoint dosya adından
//   doğru görsele otomatik yönlendirir. Görsel yüklenemezse (kırık/bulunamayan)
//   kart OTOMATİK olarak temsili avatara (baş harf + bayrak) düşer — asla boş kalmaz.
//
//   Gerçek foto eklemek/düzeltmek için:
//   1. https://commons.wikimedia.org adresinde oyuncuyu ara
//   2. Beğendiğin görsele tıkla, dosya adını al (örn: "Lionel Messi WC2022.jpg")
//   3. foto: W("Lionel Messi WC2022.jpg") şeklinde yaz
//   foto: "" bırakırsan doğrudan avatar gösterilir.
//
...
export const PLAYERS = [
  ...
  { id: 3,  name: "MBAPPÉ",     pos: "ST",  flag: "🇫🇷", ovr: 91, foto: W("Kylian Mbappé 2018.jpg"),              pac: 97, sho: 90, pas: 80, dri: 92, def: 36, phy: 78 },
  ...
  { id: 22, name: "SAKA",       pos: "RM",  flag: "🏴",   ovr: 87, foto: "",                                       pac: 84, sho: 82, pas: 82, dri: 87, def: 56, phy: 72 },
  ...
  { id: 30, name: "DYBALA",     pos: "CF",  flag: "🇦🇷", ovr: 86, foto: "",                                       pac: 80, sho: 84, pas: 84, dri: 89, def: 38, phy: 62 },
];
